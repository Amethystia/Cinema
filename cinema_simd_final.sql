...
(18, 'Little India', '2', 39),
(19, 'Little India', '3', 39),
...
--
ALTER TABLE `bookedtickets`
  MODIFY `Ticket_BookId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `bookingcinema`
--
ALTER TABLE `bookingcinema`
  MODIFY `Cinema_BookId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
