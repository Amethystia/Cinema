...
CREATE TABLE `bookingcinema` (
  ...
  `Requestor` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `Cinema` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `promotion` (`PromotionId`, `Name`, `Picture_URL`) VALUES
(1, 'Slide_1', 'C:\\Cinema\\Assets\\Promotion\\Promosi1.jpg'),
(2, 'Slide_2', 'C:\\Cinema\\Assets\\Promotion\\Promosi2.Jpg'),
...
INSERT INTO `user` (`ID`, `Name`, `Password`, `Status`, `Sex`, `BirthDate`, `Address`, `IsEmployee`) VALUES
